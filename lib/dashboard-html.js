...
<div class="page-wrap">
<div id="scoring-progress-banner" style="display:none;background:#1f2937;border:1px solid #374151;padding:10px 14px;margin:8px 16px;border-radius:8px;font-size:13px;color:#e5e7eb;display:none;align-items:center;gap:12px">
  <span style="font-size:16px">&#9203;</span>
...
<script src="/public/dashboard.js?v=6"></script>
<script>
(function() {
