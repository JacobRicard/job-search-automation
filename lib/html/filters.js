...
function renderLocationDropdown(locationPrefs, metros) {
  ...
  return `<div class="dd-wrap">
    ...
    <div id="location-panel" class="filter-dropdown loc-dropdown">
      <div class="loc-metros">
        <select id="loc-metro-select" class="loc-metro-select">
      ...
      <label class="loc-unlisted-label">
        <input type="checkbox" id="loc-include-unlisted"${includeUnknown ? ' checked' : ''}>
        <span>No listed location</span>
      </label>
      <div class="loc-divider"></div>
