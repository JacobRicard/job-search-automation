...
<div class="modal-overlay" id="questions-copy-modal">
  <div class="modal" style="max-width:680px">
    <h2 id="questions-copy-title">Copy Answers</h2>
    <div class="modal-sub" id="questions-copy-sub"></div>
    <div id="questions-copy-list" style="margin-top:12px;max-height:60vh;overflow-y:auto"></div>
    <div class="modal-actions">
      <button class="btn" style="background:var(--slate);color:var(--text-muted)" onclick="closeQuestionsCopy()">Close</button>
    </div>
  </div>
</div>`;
}
