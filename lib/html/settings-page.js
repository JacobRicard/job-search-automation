...
function renderSettingsPage() {
  ...
  const apiKeysSection = section('api-keys', 'API Keys',
    ...
    2,
    field('s-groq-key',        'Groq API Key',              { type: 'password', placeholder: 'gsk_...',   hint: 'Required for scoring. Free key at console.groq.com' }) +
  ...
  const companiesSection = section('companies', 'Scraper Targets',
    ...
    `<div class="sfield" style="grid-column:1/-1">
      ...
      <textarea id="s-workday" rows="4" placeholder='[{"sub":"jpmorgan","wd":"jpmorganchaseandco","board":"JP_Morgan_Chase"}]' style="width:100%;font-family:var(--font-mono,monospace);font-size:12px"></textarea>
      <p class="sfhint">Array of {sub, wd, board} objects. Find these from the company&apos;s Workday job URL.</p>
    </div>`,
    'companies'
  );
