...
function renderHelpPage() {
  ...
  const routesCode = [
    ...
    'GET  /auto-apply-attempt      auto-apply receipt JSON',
    ...
    <div class="help-page-grid help-page-grid-3">
      ...
      ${renderCard({
        ...
        bullets: [
          ...
          'Shows seniority distribution, location breakdown, skill clusters, strategy score, and high-score emerging signals',
    ...
    <div class="help-page-grid help-page-grid-3">
      ...
      ${renderCard({
        ...
        bullets: [
          ...
          'Auto-apply receipts capture status, mode, platform, failure class, screenshots, and resume artifacts for later audit',
