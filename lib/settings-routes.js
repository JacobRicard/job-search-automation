...
const ENV_KEYS = [
  'GEMINI_API_KEY', 'SAPLING_API_KEY', 'HUGGINGFACE_API_KEY',
  'OLLAMA_HOST', 'OLLAMA_SCORE_MODEL', 'OLLAMA_FILTER_MODEL',
  'CLAUDE_CODE_EXECPATH', 'CLAUDE_SCORE_MODEL', 'CLAUDE_FILTER_MODEL',
  'LOCATION_FILTER', 'LOCATION_BLOCKLIST', 'TITLE_BLOCKLIST', 'AUTO_ARCHIVE_THRESHOLD',
  'BUILTIN_SUBDOMAIN', 'TZ', 'REFRESH_INTERVAL_MINUTES',
  'JOBSPY_ENABLED', 'JOBSPY_CONFIG_PATH',
  'SMTP_HOST', 'SMTP_PORT', 'SMTP_SECURE', 'SMTP_USER', 'SMTP_PASS', 'SMTP_FROM',
  'DIGEST_TO', 'DIGEST_MIN_SCORE', 'DIGEST_MAX_JOBS', 'DIGEST_LOOKBACK_HOURS', 'DIGEST_SEND_TIME',
